# ComputerGraphics
## These are the assignments I have done in Vicotira University of Wellington Using C++, OpenGL, and OpenCV

# Requirements for OpenGL Projects
...
## Using CLion doesn't require building the project.

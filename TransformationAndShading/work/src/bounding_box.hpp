...
inline static cgra::gl_mesh createBoundingBoxMesh(const glm::vec3 &minv, const glm::vec3 &maxv, int num, glm::mat4 trans[], glm::vec3 cols[]) {
	...
	return mb.build(num, trans, cols);
}